...
public class Agent {
    ...
    private static final String myClassPath = "ru/julia/aop/instrumentation/addSetter/MyClass";
    ...
    private static byte[] addMethod(byte[] originalClass) {
        ...
        mv.visitFieldInsn(Opcodes.PUTFIELD, myClassPath, "value", "I");
        ...
        try (OutputStream fos = new FileOutputStream("addSetter.class")) {
