...
public class Agent {
    ...
    private static final String myClassPath = "ru/julia/aop/instrumentation/changeAction/MyClass";
    private static final String methodForChange = "summator";
    ...
    public static void premain(String agentArgs, Instrumentation inst) {
        ...
        inst.addTransformer(new ClassFileTransformer() {
            ...
            public byte[] transform(
                ...
                if (className.equals(myClassPath)) {
    ...
    private static byte[] changeMethod(byte[] originalClass) {
        ...
        ClassVisitor cv = new ClassVisitor(Opcodes.ASM7, cw) {
            ...
            public MethodVisitor visitMethod(
                ...
                if (name.equals(methodForChange)) {
        ...
        try (OutputStream fos = new FileOutputStream("changeAction.class")) {
    ...
    private static class ChangeMethodVisitor extends AdviceAdapter {
        ...
        public void visitLocalVariable(
                ...
                final Label end,
                final int index) {
            logger.info("visited name:{}, descriptor:{}, signature:{}, index:{}",
