package ru.julia.processrunner;
...
public class ProcessRunner {
    private static final String BASE_PATH = "./processes-demo";
    ...
    private static final String JOBS_PACKAGE_DIR = "/ru/julia/processrunner/jobs/";
    private static final String JOB_CLASS = "ru.julia.processrunner.jobs.Job";
